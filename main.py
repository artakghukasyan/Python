...
class Login:
	def __init__(self,root):
		...
		self.login_text = tk.Label(self.login_frame, text = "User Login", bg='#131313', fg = '#E9E9E9', font = ("Arial",35,'bold'))
		...
		self.username_text = tk.Label(self.user_frame, text = 'USERNAME', bg= "#131313", fg='#595959',font = ("Calibri",14,'bold'))
		...
		self.password_text = tk.Label(self.user_frame, text = 'PASSWORD', bg= "#131313", fg='#595959',font = ("Calibri",14,'bold'))
		...
		# Button
		self.button = tk.Button(self.user_frame, text = 'Login',bg = '#0386FC', fg = '#BDF4FF',width = 15, font = ("Arial", 15,'bold'), command = self.login)
	...
	def login(self, event = None):
		...
		if self.username_value == 'admin' and self.password_value == 'admin':
			self.errors_text.config(text = "You have successfully signed in", fg = 'green')
			self.username_entry.delete(0,tk.END)
			self.password_entry.delete(0,tk.END)
			self.root.destroy()
			App(True)
		else:
			self.errors_text.config(text="The username or password is incorrect",fg= 'red')
			self.username_entry.delete(0,tk.END)
			self.password_entry.delete(0,tk.END)
